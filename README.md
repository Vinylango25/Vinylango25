...
| [🛡️ Anomaly and Fraud Detection in Finance](https://github.com/Vinylango25/Anomaly-Fraud-detection-in-Finance) | Built anomaly detection models to identify fraudulent transactions from an imbalanced credit card dataset. Used Logistic Regression, Random Forest, Gradient Boosting, LightGBM, KNN, and Isolation Forest. Conducted global and local explainability analysis using LIME and SHAP for trust and interpretability. | Python, Scikit-learn, LightGBM, PyOD, LIME, SHAP |
